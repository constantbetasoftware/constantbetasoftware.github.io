---
layout: post
title: (Not) The Year of Email
---


**Note:** Back in 2012 I was working in the email space, trying to improve the modern-day-worker's life (this was before pg's [Frighteningly Ambitious Startup Ideas](http://www.paulgraham.com/ambitious.html) came out and everyone started talking about email, mind you). Unfortunately we did not succeed (otherwise this blog would be a lot more popular).
...
I still believe that the field is ripe for massive change (and [I guess I'm not the only one](https://techcrunch.com/2017/08/18/rapportive-founders-new-startup-superhuman-is-what-gmail-would-be-if-built-today/)), so I'm reposting my original post here, for eternity.
...
[SendGrid](http://sendgrid.com/) provides a cloud-based email infrastructure with reliable delivery, scalability and real-time analytics. They face competition from recently funded [Mailjet](https://www.mailjet.com/).
...
*Originally written on the 26th of April of 2013.*
